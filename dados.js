const dados = [
  ...
  "O president Dwight Eisenhower ordena as tropas federais que proteja 9 alunos afro-americanos que começaram a estudar no colégio Little Rock para alunos brancos, essa foi a primeira ação do governo federal contra a segregação racial no país.",
  ...
  "Dois jatos super-sônicos Concorde levatam voo simultâneamente. Um partindo de Londres para o Barein, e outro de Paris, para o Rio de Janeiro.",
  "Os primeiros computadores pessoais modernos começam a surgir",
  "Mais de 900 pessoas morrem em um suícidio em massa promovido por um culto em Jonestown, promovido por Jim Jones.",
  ...
  "A nave Challenger exploduiu 73 segundos após decolar do Cabo Canaveral, causando a morte de 7 astronautas.",
  ...
  "Acontece a queda do muro de Berlin.",
  ...
  "Os Estados Unidos vão para a guerra do oriente médio após Sadam Hussain invadir o Kuait.",
  "A guerra fria entre Rússia e os EUA termina semanas após o fim da União Soviética.",
  "É criada a União Européia.",
  "O site Amazon.com é lançado",
  "Ataque terrorista acontece em Olklahoma com a explosão de um caminhão-bomba.",
  ...
  "Os Estados Unidos inciam os ataques ao Iraque",
  ...
  "Edward Snowden expões segredos de estado dos Estados Unidos e de governos europeus sobre espionagem de outros países.",
  ...
  "Em um espaço de 4 semanas, 3 furações atingem os Estados Unidos, Harvey, Irma e Maria atingiram o Texas, Florida e  o Caribe",
